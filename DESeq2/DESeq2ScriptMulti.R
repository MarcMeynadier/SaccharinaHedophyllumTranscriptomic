...
png('../DESeq2/Saccharina/PCA_Saccharina.png', width=7, height=7, units = "in", res = 300)
...
png('../DESeq2/Hedophylum/PCA_Hedophylum.png', width=7, height=7, units = "in", res = 300)
...
heatmap_genes(stressListSaccharina,vsdSaccharina,'Saccharina','stress / oxydo-reduction',colnamesSaccharina)
heatmap_genes(photoListSaccharina,vsdSaccharina,'Saccharina','photorespiration / energy production',colnamesSaccharina)
...
heatmap_genes(cytoskeletonListHedophylum,vsdHedophylum,'Hedophyllum','cytoskeleton',colnamesHedophylum)
heatmap_genes(geneticListHedophylum,vsdHedophylum,'Hedophyllum','transcription / translation',colnamesHedophylum)
heatmap_genes(metaboListHedophylum,vsdHedophylum,'Hedophyllum','metabolism',colnamesHedophylum)
heatmap_genes(signalingListHedophylum,vsdHedophylum,'Hedophyllum','signaling',colnamesHedophylum)
heatmap_genes(transportListHedophylum,vsdHedophylum,'Hedophyllum','transport',colnamesHedophylum)
heatmap_genes(stressListHedophylum,vsdHedophylum,'Hedophyllum','stress / oxydo-reduction',colnamesHedophylum)
heatmap_genes(photoListHedophylum,vsdHedophylum,'Hedophyllum','photorespiration / energy production',colnamesHedophylum)
